# Functions in Python are first class citizen i.e Functions are objects that can be returned, passed as arguments to another functions,
# can be stored as objects in other structures, can nests other functions too & nexted functions remembers the states of parent functions.
# These are the features which make python function a really powerful, and helps the functional programming in python.

# Function nestings, returning functions example:
